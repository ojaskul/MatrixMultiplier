...
HD_PWD='C:/Users/ojasa/OneDrive/Documents/Research/REU2023/ReconfigMM2/ReconfigMM2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ReconfigMM2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ReconfigMM2.tcl -notrace
