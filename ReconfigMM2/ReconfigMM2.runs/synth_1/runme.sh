...
HD_PWD='C:/Users/ojasa/OneDrive/Documents/Research/REU2023/ReconfigMM2/ReconfigMM2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReconfigMM2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReconfigMM2.tcl
