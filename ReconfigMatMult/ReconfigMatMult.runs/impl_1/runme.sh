...
HD_PWD='C:/Users/ojasa/OneDrive/Documents/Research/REU2023/ReconfigMatMult/ReconfigMatMult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelRMM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLevelRMM.tcl -notrace
