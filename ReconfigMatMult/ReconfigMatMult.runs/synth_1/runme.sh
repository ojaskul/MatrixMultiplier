...
HD_PWD='C:/Users/ojasa/OneDrive/Documents/Research/REU2023/ReconfigMatMult/ReconfigMatMult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelRMM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevelRMM.tcl
